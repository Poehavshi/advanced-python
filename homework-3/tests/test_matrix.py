...
def test_matrix_addition():
    ...
    mat2 = Matrix(data2)
    mat3 = mat1 + mat2
    assert mat3.data == tuple(map(tuple, np.add(data1, data2).tolist()))
...
def test_matrix_subtraction():
    ...
    mat2 = Matrix(data2)
    mat3 = mat1 - mat2
    assert mat3.data == tuple(map(tuple, np.subtract(data1, data2).tolist()))
...
def test_matrix_multiplication():
    ...
    mat2 = Matrix(data2)
    mat3 = mat1 * mat2
    assert mat3.data == tuple(map(tuple, np.matmul(data1, data2).tolist()))
...
def test_matrix_elementwise_multiplication():
    ...
    mat2 = Matrix(data2)
    mat3 = mat1 @ mat2
    assert mat3.data == tuple(map(tuple, np.multiply(data1, data2).tolist()))
